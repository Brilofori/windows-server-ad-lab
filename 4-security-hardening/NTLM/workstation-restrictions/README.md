...
This section contains Group Policy Objects used to harden workstation environments for different user roles within the lab.

Staff Restrictions

Policies applied to standard staff accounts to reduce access to administrative tools and limit lateral movement opportunities.
